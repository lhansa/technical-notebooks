...
+-----------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------+
| Calcula la media de una métrica por grupo.                                                    | `iris |> group_by(Species) |> summarise(mean(Sepal.Length))`              | `aggregate(Sepal.Length ~ Species, iris, mean)`                                                                             |
+-----------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------+
| Extrae los números de un texto (aplica a cualquer patrón, como DNI, razón social, etc).       | `str_extract("cosa123cosa", "\\d+")`                                      | `regmatches("cosa123cosa", m = regexpr("\\\\d+", "cosa123cosa", perl = TRUE))`                                              |
+-----------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------+
| Quédate con las observaciones cuyo valor (en una métrica) sea mayor que la media de su grupo. | `iris |> group_by(Species) |> filter(Sepal.Lengh >= mean(Sepal.Length))`  | `do.call("rbind", lapply(split(iris, iris\$Species), function(df) { subset(df, Sepal.Length >= mean(df\$Sepal.Length)) }))` |
+-----------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------+
| (\*) Pasa de formato ancho a formato largo - Transformación *melt* - Pasa métricas a filas    | `iris |> pivot_longer(-Species)`                                          | `iris$id <- 1:nrow(iris)` \                                                                                                 |
