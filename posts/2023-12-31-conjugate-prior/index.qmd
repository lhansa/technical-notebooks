...
Dejo por ahora el código de golpe, porque es Nochevieja y tengo cosas que hacer. 

El Leo del futuro se encargará de contar esto bien. 
...
beta_alpha <- 2
beta_beta <- 10
hist(rbeta(sample_size, beta_alpha, beta_beta))
